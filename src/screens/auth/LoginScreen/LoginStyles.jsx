...
export const styles = StyleSheet.create({
    ...
    inputContainer: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: colors.white, borderRadius: 100, paddingHorizontal: 20, padding: 2, marginVertical: 10 },
    textInput: { flex: 1, paddingHorizontal: 10, fontFamily: fonts.Light, color: colors.white },
